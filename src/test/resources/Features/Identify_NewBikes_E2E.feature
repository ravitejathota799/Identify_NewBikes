...
Feature: Identify New Bike E2E testing suite in the zig wheels website
  ...
  Scenario: Display "Upcoming" bikes details like bike name, price and expected launch date in India, for manufacturer 'Honda' & Bike price should be less than 4Lac. in the zig wheels website
  ...
  Scenario: For Used cars in Chennai, extract all the popular models in a List; Display the same in the zig wheels website
