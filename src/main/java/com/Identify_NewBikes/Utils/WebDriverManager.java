...
public class WebDriverManager {
	...
	public WebDriver createDriver(String browser) throws IOException {
		if (getProperties().getProperty("execution_env").equalsIgnoreCase("remote")) {
			...
			case "chrome":
				...
				driver = new ChromeDriver(options); // creating an instance for the chrome driver
				break;
			case "edge":
				EdgeOptions options1=new EdgeOptions();
				options1.addArguments("--headless");
				driver = new EdgeDriver(options1); // creating an instance for the edge driver
				break;
			case "firefox":
